...
// Only needy users may view this page
...
<head>
  ...
  <title>Claim History | Waste-Not-Kitchen</title>
  <link rel="stylesheet" href="../../../assets/css/needy-activity.css" />
  <style>
...
<body>
  ...
  <div class="activity-wrap">
    <div class="box claims-box">
      <div class="box-header">Claim History</div>
      <div class="tabs">
        <button class="tab-btn active" data-filter="reserved">Reserved</button>
        <button class="tab-btn" data-filter="claimed">Claimed</button>
      </div>
      <div id="claims-list" class="list">
        <div class="small-muted">Loading…</div>
      </div>
    </div>
  </div>

  <script src="../../../assets/js/needy-activity.js"></script>
</body>
</html>
