...
// Only donors may view this page
...
<head>
  ...
  <link rel="stylesheet" href="../../../assets/css/donor-activity.css" />
  <style>
...
<body>
  ...
  <div class="top-actions">
    <a class="btn back" href="/Waste-Not-Kitchen/modules/donor/donor-dashboard.php">Back to Dashboard</a>
    <a class="btn" href="profile.php">Back to Profile</a>
  </div>

  <div class="activity-wrap">
    <div class="box donations-box">
      <div class="box-header">Donation History</div>
      <div class="tabs">
        <button class="tab-btn active" data-filter="reserved">Reserved</button>
        <button class="tab-btn" data-filter="claimed">Paid &amp; Picked Up</button>
      </div>
  ...
  <script src="../../../assets/js/donor-activity.js"></script>
</body>
</html>
