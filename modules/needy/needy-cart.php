...
if (empty($_SESSION['user_id'])) {
    $_SESSION['flash_message'] = 'Please sign in to view your reserved plates.';
...
$sql = "
    ...
    WHERE d.needy_id = :nid AND d.status = 'reserved'
                        ...
                        <?php foreach ($cartItems as $item): ?>
                            ...
                            <div class="cart-item">
                                ...
                                <div class="item-body">
                                    ...
                                    <form method="post" action="needy_cancel_reservation.php" onsubmit="return confirm('Cancel reservation? This will free one reservation slot if it has not been picked up. Continue?');">
